...
def create_reference_motion_scenario() -> ReferenceMotionScenario:
    ...
    entities = (
        LaneMobileEntity("M1", node(226, 588), node(900, 190), 72, (58, 150, 26)),
        LaneMobileEntity("M2", node(962, 648), node(259, 343), 60, (45, 131, 211), width=14, height=10),
        LaneMobileEntity("M3", node(289, 112), node(870, 618), 54, (46, 46, 48), EntityShape.CIRCLE, 10, 10),
        LaneMobileEntity("M4", node(226, 219), node(962, 433), 66, (185, 143, 46), EntityShape.DIAMOND, 11, 11),
        LaneMobileEntity("M5", node(625, 618), node(289, 190), 58, (48, 177, 63)),
    )
